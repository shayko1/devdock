...
const DEVDOCK_ENV_MD = `# DevDock — AI Terminal Environment
...
export function ensureDevDockClaudeMd(cwd: string, rtkEnabled?: boolean) {
  try {
    const claudeMdPath = join(cwd, 'CLAUDE.md')
    const marker = '# DevDock'

    let fullContent = DEVDOCK_ENV_MD
